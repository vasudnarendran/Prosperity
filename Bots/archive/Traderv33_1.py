...
TOMATOES = {
    ...
    "SPREAD_ALPHA_REBATE": 0.40,
    "PASSIVE_MIN_EV": 0.02,
    "QUEUE_VALUE_COEF": 0.45,
    "PASSIVE_ADVERSE_COEF": 0.75,
    "POST_FILL_DECAY": 0.65,
    "POST_FILL_MAX_BIAS": 2.0,
    "POST_FILL_QUOTE_PENALTY": 0.25,
    "POST_FILL_TAKE_PENALTY": 0.18,
    "MARKOUT_DELAY_TICKS": 300,
    "MARKOUT_SCALE": 0.18,
    "RLS_SKIP_SPREAD": 18.0,
    "RLS_SKIP_TOXIC": 0.75,
    "RLS_TARGET_CLIP": 4.0,
    "RLS_BETA_CLIP": 2.00,
    "RESIDUAL_ALPHA_WEIGHT": 0.35,
    "MOMENTUM_RESIDUAL_WEIGHT": 0.10,
    "REGIME_TREND_COEF": 1.55,
    "REGIME_FLOW_COEF": 0.90,
    "REGIME_TOXIC_COEF": 0.95,
}
