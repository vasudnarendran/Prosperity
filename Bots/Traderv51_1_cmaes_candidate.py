...
class TomatoesBot:
    ...
    ALPHA_CAP = 2.2
    ALPHA_BLEND_WEIGHT = 0.2561868791
    ...
    FAIR_WALL_WEIGHT = 0.4140066336
    FAIR_MID_WEIGHT = 0.18
    FAIR_MICRO_WEIGHT = 0.1967683948
    FAIR_FLOW_WEIGHT = 0.08
    FAIR_REGRESSION_WEIGHT = 0.0816081952
    FAIR_ALPHA_WEIGHT = 0.3306869143
    POSITION_BIAS_DIVISOR = 16.0
    RANGE_REVERT_WEIGHT = 0.18
    TREND_BONUS_WEIGHT = 0.10

    INVENTORY_SKEW = 0.0491295128
    BASE_QUOTE_EDGE = 2.0962431739
    BASE_TAKE_EDGE = 0.8108433544
    MAX_TAKE_SIZE = 10
    PASSIVE_SIZE = 8
    SOFT_LIMIT = 26

    TREND_EDGE_THRESHOLD = 0.9048733981
    STRONG_TREND_EDGE = 1.70
    FIT_THRESHOLD = 0.3838805092
    TOXIC_SPREAD = 12
    TOXIC_VOL = 2.8
