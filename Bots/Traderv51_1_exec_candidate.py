...
class TomatoesBot:
    ...
    ALPHA_CAP = 2.2
    ALPHA_BLEND_WEIGHT = 0.288699081
    ...
    FAIR_ALPHA_WEIGHT = 0.3411232634
    POSITION_BIAS_DIVISOR = 16.0
    RANGE_REVERT_WEIGHT = 0.18
    TREND_BONUS_WEIGHT = 0.10

    INVENTORY_SKEW = 0.0447597844
    BASE_QUOTE_EDGE = 2.056369921
    BASE_TAKE_EDGE = 0.8342286503
    MAX_TAKE_SIZE = 10.6339279583
    PASSIVE_SIZE = 7.9565244695
    SOFT_LIMIT = 26

    TREND_EDGE_THRESHOLD = 0.9667534026
    STRONG_TREND_EDGE = 1.70
    FIT_THRESHOLD = 0.4249385199
    TOXIC_SPREAD = 12
    TOXIC_VOL = 2.8
